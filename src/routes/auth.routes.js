...
/**
 * @description 사용자 회원가입을 처리하는 컨트롤러 (DB 없는 임시 버전)
 */
...
/**
 * @description 사용자 로그인을 처리하는 컨트롤러 (DB 없는 임시 버전)
 */
...
/**
 * @description 토큰 유효성을 검증하는 컨트롤러 (DB 없는 임시 버전)
 */
...
// 🔥 기존 테스트 함수들은 그대로 유지
export const registerTest = register;
export const loginTest = login;
export const verifyTest = verify;